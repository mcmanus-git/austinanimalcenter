...
dash.register_page(
    ...
    title="AAC Insights",
    description="""
    Machine Learning, Data Exploration, and Analytics Web Application showcasing that leveraging data supports Austin 
    Animal Center's operational efficiency and increase animal adoption rates.
    """,
)
